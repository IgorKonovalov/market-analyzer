...
COMPUTE_WALLET_PNL_DESCRIPTION = (
    ...
    "windows is the per-position realized P&L over a fixed rolling set "
    "([{window: 7d|30d|90d|all, realized_usd}]): exact, anchored to the run's "
    "analysis time, with the 'all' window equal to the position's all-time realized_usd. "

...
export const en = {
  ...
  'alerts.defi.title': 'DeFi position alerts',
  'alerts.defi.loading': 'Loading DeFi position alerts…',
  'alerts.defi.historyError': 'Failed to load DeFi position alerts:',
  'alerts.defi.nothingFired': 'No out-of-range alerts yet.',
  'alerts.defi.rowCondition': 'out of range {hours}h — tick {tick} outside [{lower}, {upper})',
  'alerts.defi.osTitle': 'LP position out of range',

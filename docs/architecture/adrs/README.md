...
- **Numbering** is sequential, zero-padded to four digits, never reused. **Next free ADR number is 0072** (0071 — advisor non-voting inputs + direction demotion, proposed 2026-07-10, paired with Plan 0077 — is the highest drafted; the roster above is the full inventory, and per-ADR drafting history lives in each file's `Date:` header + `git log`). Still `proposed` and awaiting their paired plan's close: 0037 (DeFi risk — Plan 0042), 0041 (Polymarket — Plan 0040), 0043/0044 (execution — Plan 0044), 0067 (Ichimoku trend classification — Plan 0073), 0068 (technical-read tier — Plan 0074), 0070/0071 (forecast pivot — Plan 0077), plus the exploratory 0025 (accepts at Plan 0046's close). (0059 accepted at Plan 0064's close 2026-07-08; 0064 accepted at Plan 0070's close 2026-07-09; 0060 accepted at Plan 0065's close 2026-07-09; 0061 accepted at Plan 0067's close 2026-07-09; 0062 accepted at Plan 0068's close 2026-07-09; 0063 accepted at Plan 0069's close 2026-07-10; 0065/0066 accepted at Plan 0072's close 2026-07-10.) The architect runs `Glob docs/architecture/adrs/*.md` before drafting to pick the next number, never trusting memory. ADR numbers and plan numbers are independent sequences.

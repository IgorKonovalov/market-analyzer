...
| [0040](0040-forecasting-model-artifacts.md) | Forecasting model artifacts: deterministic library stack (sklearn `HistGradientBoosting`) + versioning & provenance | proposed — accepts at Plan 0036 close | implements 0030 (fills its open library/determinism/persistence slots); mirrors 0018 for model artifacts | 0036 |

...
| [0064](0064-generated-sidecar-api-reference.md) | Generated sidecar API reference from live introspection of the fully-wired app (MCP registry + OpenAPI + event envelopes), CI-gated like `gen-types:check` | proposed (accepts at Plan 0070's close) | reads the 0014 MCP surface + 0017 SSE vocabulary; documents what 0046 keeps off the wire; reuses the full-toolset test's wiring | 0070 |

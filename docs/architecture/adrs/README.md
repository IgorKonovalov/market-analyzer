...
| [0048](0048-classical-chart-pattern-detection.md) | Classical chart-pattern detection (swing-pivot foundation, two-state forming/confirmed, trailing) | proposed — accepts at Plan 0052 close | amends 0023 scope (candlestick-only); mirrors 0045 (derived); paired with 0049 | 0052 |
| [0049](0049-chart-trendline-overlay-primitive.md) | Chart trendline overlay primitive (sloped multi-point geometry via `ISeriesPrimitive`) | proposed — accepts at Plan 0052 close | extends 0017 chart schema; follows 0045 primitive precedent; paired with 0048 | 0052 |
| [0050](0050-short-selling-strategy-backtest.md) | Short-selling in the strategy + backtest contract (`enter_short`/`exit_short`, frictionless symmetric P&L) | proposed — accepts at Plan 0053 close | amends 0004 (long-only `SignalKind`); extends 0018 (engine + determinism golden); relates 0024/0025 | 0053 |
| [0051](0051-historized-metric-series-contract.md) | Historized external metric series: one contract, one table (`metric_points` + `as_of` join) | proposed — accepts at Plan 0055 close | extends 0006 (cache); historizes 0027's snapshot; follows 0031; serves 0030 causality | 0055 (0056/0057 historize through it) |
| [0052](0052-binance-exchange-data-source.md) | Binance public API as crypto exchange data source; exchange pairs are distinct symbols (membership routing) | proposed — accepts at Plan 0058 close | adds an OhlcvSource under 0007/0031; relates 0019/0028; series land per 0051; venue-aligned with 0043 | 0056, 0058 |
| [0053](0053-onchain-valuation-source.md) | On-chain valuation source: CoinMetrics community primary, blockchain.com as MVRV cross-check | proposed — accepts at Plan 0057 close | sources under 0031; stores per 0051; feeds 0054 | 0057 |
| [0054](0054-exogenous-forecast-features-multi-horizon.md) | Exogenous forecast features join lag-1 as-of; horizons validate independently | proposed — accepts at Plan 0059 close | extends 0030 (invariants to exogenous inputs; N-bar already reserved); flows into 0040 versioning; builds on 0051 | 0059 |
| [0055](0055-in-sidecar-watch-scheduler.md) | Alerting as an in-sidecar scheduler; alerts are edge-triggered conditions | proposed — accepts at Plan 0060 close | rides 0016 (standalone sidecar) + 0017/0021 (delivery); bounded by 0029 (no advice) | 0060 |

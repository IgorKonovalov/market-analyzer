...
| [0045](0045-candlestick-pattern-span-delivery.md) | Candlestick pattern delivery: span-bearing markers, derived not persisted | proposed — accepts at Plan 0049 close | extends the 0017 highlight channel; relates 0023 (pattern surface) / 0006 (derived-not-persisted) | 0049 |

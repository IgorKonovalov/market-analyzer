...
The committed roster (Tier 2 0009–0012, then 0013–0014) is fully closed, as are the capability-expansion gates 0018, 0019, 0025, and 0027, the analysis batch's 0021, the macro-context plan 0022, and (2026-06-03) the lazy-loading pair 0030/0031. **Pickup-ready now, all `approved` and on largely disjoint files (user may re-prioritise): 0020, 0023, 0026.** Serialize where files overlap:

...
flowchart LR
    ...
    subgraph Sidecar["Python sidecar (standalone process)"]
        ...
        Routes["Renderer routes (renderer bearer)<br/>/healthz · /ohlcv · /quote · /search · /annotations<br/>/backtests · /news · /scan_patterns · /scan_chart_patterns<br/>/track_record<br/>/ui_events · /defi/scan · /defi/pnl · /watches · /alerts<br/>/settings/* · /stop · /events (SSE)"]

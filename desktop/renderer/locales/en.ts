...
export const en = {
  ...
  'portfolio.lede':
    'Your cross-venue holdings, cost basis, unrealized P&L and exposure — plus conditional DeFi position risk. Facts only, no recommendations.',
  'portfolio.walletLabel': 'DeFi wallet (optional)',
  'portfolio.walletPlaceholder': '0x…',
  'portfolio.includeBasis': 'Include DeFi cost basis',
  'portfolio.load': 'Load',
  'portfolio.invalidWallet': 'Enter a valid 0x… address, or leave it blank.',
  'portfolio.loading': 'Loading portfolio…',
  'portfolio.empty': 'No holdings found.',
  'portfolio.error.setKeyHint':
    'No account source configured — set your venue keys in Settings to read your holdings.',
  'portfolio.summary.unrealized': 'Unrealized P&L',
  'portfolio.summary.exposureVenue': 'Exposure by venue',
  'portfolio.summary.exposureAsset': 'Exposure by asset',
  'portfolio.legsAsOfLabel': 'Data as of (per venue)',
  'portfolio.legError': 'Could not read the {venue} leg: {reason}',
  'portfolio.notesLabel': 'Notes',
  'portfolio.holdingsLabel': 'Holdings',
  'portfolio.col.venue': 'Venue',
  'portfolio.col.asset': 'Asset',
  'portfolio.col.quantity': 'Quantity',
  'portfolio.col.avgCost': 'Avg cost',
  'portfolio.col.value': 'Value (USD)',
  'portfolio.col.pricingSource': 'Priced by',
  'portfolio.col.asOf': 'As of',
  'portfolio.risk.title': 'DeFi position risk',
  'portfolio.risk.lede':
    'Conditional facts under the inputs you supply — a condition read, never advice or an action.',
  'portfolio.risk.aaveTitle': 'Aave account',
  'portfolio.risk.lpTitle': 'Liquidity position',
  'portfolio.risk.addressLabel': 'Account address',
  'portfolio.risk.chainLabel': 'Chain',
  'portfolio.risk.chainBase': 'base',
  'portfolio.risk.chainEthereum': 'ethereum',
  'portfolio.risk.shockLabel': 'Price shock',
  'portfolio.risk.collateralSymbolLabel': 'Collateral symbol',
  'portfolio.risk.collateralSymbolPlaceholder': 'ETH',
  'portfolio.risk.horizonLabel': 'Horizon (days)',
  'portfolio.risk.scenarioTab': 'Scenario',
  'portfolio.risk.conditionalTab': 'Probability',
  'portfolio.risk.recompute': 'Recompute',
  'portfolio.risk.computeProbability': 'Compute probability',
  'portfolio.risk.hfBefore': 'Health factor (before)',
  'portfolio.risk.hfAfter': 'Health factor (after)',
  'portfolio.risk.liqDistBefore': 'Liquidation distance (before)',
  'portfolio.risk.liqDistAfter': 'Liquidation distance (after)',
  'portfolio.risk.pLiq': 'P(liquidation, {days}d)',
  'portfolio.risk.assumption': 'Assumption: {assumption}',
  'portfolio.risk.impermanentLoss': 'Impermanent loss',
  'portfolio.risk.valueBefore': 'Value (before)',
  'portfolio.risk.lpValueAfter': 'LP value (after)',
  'portfolio.risk.hodlValueAfter': 'HODL value (after)',
  'portfolio.risk.amount0': 'Token 0 amount',
  'portfolio.risk.price0': 'Token 0 price (USD)',
  'portfolio.risk.amount1': 'Token 1 amount',
  'portfolio.risk.price1': 'Token 1 price (USD)',
  'portfolio.risk.lpHint': 'Token 1 is held as the numeraire (unshocked); the shock moves token 0.',
  'portfolio.risk.loading': 'Computing…',
  'portfolio.risk.error': 'Risk recompute failed: {message}',
  'portfolio.risk.aaveInputsHint':
    'Enter an Aave account address to read its health factor and liquidation distance.',

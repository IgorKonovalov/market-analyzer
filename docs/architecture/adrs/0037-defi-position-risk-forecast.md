...
> **Status:** proposed — accepts at the DeFi risk/forecast plan close (forthcoming in the 0032+ series — see [plans README](../plans/README.md))
> **Date:** 2026-06-03
> **Related plan(s):** forthcoming DeFi series (the risk/forecast plan)

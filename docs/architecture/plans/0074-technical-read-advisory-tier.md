...
- **Files touched:** `src/market_analyser/advisor/models.py` (add `TechnicalRead`), `src/market_analyser/advisor/technical_read.py` (new), `tests/advisor/test_technical_read.py` (new).
- **Design notes:**

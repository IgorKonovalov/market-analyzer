...
| [0063](0063-in-house-i18n-and-reason-codes.md) | In-house renderer-side i18n (zero-dep `t()` over typed en/ru catalogs, en-US numbers kept) + structured sidecar reason-codes; sidecar stays English-authoritative | proposed (accepts at Plan 0069's close) | extends 0039 (locale pref joins theme pref in the localStorage store); localizes verbatim surfaces only, leaning on 0015 (agent self-localizes conversation); dynamic upstream text English by design | 0069 |

...
export const ru = {
  ...
  'portfolio.lede':
    'Ваши активы по всем площадкам, себестоимость, нереализованный P&L и экспозиция — плюс условный риск DeFi-позиций. Только факты, без рекомендаций.',
  'portfolio.walletLabel': 'DeFi-кошелёк (необязательно)',
  'portfolio.walletPlaceholder': '0x…',
  'portfolio.includeBasis': 'Учитывать себестоимость DeFi',
  'portfolio.load': 'Загрузить',
  'portfolio.invalidWallet': 'Введите корректный адрес 0x… или оставьте поле пустым.',
  'portfolio.loading': 'Загрузка портфеля…',
  'portfolio.empty': 'Активы не найдены.',
  'portfolio.error.setKeyHint':
    'Источник аккаунта не настроен — укажите ключи площадок в Настройках, чтобы видеть активы.',
  'portfolio.summary.unrealized': 'Нереализованный P&L',
  'portfolio.summary.exposureVenue': 'Экспозиция по площадкам',
  'portfolio.summary.exposureAsset': 'Экспозиция по активам',
  'portfolio.legsAsOfLabel': 'Данные по состоянию на (по площадкам)',
  'portfolio.legError': 'Не удалось прочитать сегмент {venue}: {reason}',
  'portfolio.notesLabel': 'Примечания',
  'portfolio.holdingsLabel': 'Активы',
  'portfolio.col.venue': 'Площадка',
  'portfolio.col.asset': 'Актив',
  'portfolio.col.quantity': 'Количество',
  'portfolio.col.avgCost': 'Средняя цена',
  'portfolio.col.value': 'Стоимость (USD)',
  'portfolio.col.pricingSource': 'Оценка по',
  'portfolio.col.asOf': 'На момент',
  'portfolio.risk.title': 'Риск DeFi-позиции',
  'portfolio.risk.lede':
    'Условные факты при заданных вами вводных — это чтение условий, а не совет или действие.',
  'portfolio.risk.aaveTitle': 'Аккаунт Aave',
  'portfolio.risk.lpTitle': 'Позиция ликвидности',
  'portfolio.risk.addressLabel': 'Адрес аккаунта',
  'portfolio.risk.chainLabel': 'Сеть',
  'portfolio.risk.chainBase': 'base',
  'portfolio.risk.chainEthereum': 'ethereum',
  'portfolio.risk.shockLabel': 'Ценовой шок',
  'portfolio.risk.collateralSymbolLabel': 'Символ залога',
  'portfolio.risk.collateralSymbolPlaceholder': 'ETH',
  'portfolio.risk.horizonLabel': 'Горизонт (дней)',
  'portfolio.risk.scenarioTab': 'Сценарий',
  'portfolio.risk.conditionalTab': 'Вероятность',
  'portfolio.risk.recompute': 'Пересчитать',
  'portfolio.risk.computeProbability': 'Рассчитать вероятность',
  'portfolio.risk.hfBefore': 'Health factor (до)',
  'portfolio.risk.hfAfter': 'Health factor (после)',
  'portfolio.risk.liqDistBefore': 'Дистанция до ликвидации (до)',
  'portfolio.risk.liqDistAfter': 'Дистанция до ликвидации (после)',
  'portfolio.risk.pLiq': 'P(ликвидация, {days}д)',
  'portfolio.risk.assumption': 'Допущение: {assumption}',
  'portfolio.risk.impermanentLoss': 'Непостоянные потери',
  'portfolio.risk.valueBefore': 'Стоимость (до)',
  'portfolio.risk.lpValueAfter': 'Стоимость LP (после)',
  'portfolio.risk.hodlValueAfter': 'Стоимость HODL (после)',
  'portfolio.risk.amount0': 'Количество токена 0',
  'portfolio.risk.price0': 'Цена токена 0 (USD)',
  'portfolio.risk.amount1': 'Количество токена 1',
  'portfolio.risk.price1': 'Цена токена 1 (USD)',
  'portfolio.risk.lpHint':
    'Токен 1 держится как расчётная единица (без шока); шок сдвигает токен 0.',
  'portfolio.risk.loading': 'Расчёт…',
  'portfolio.risk.error': 'Не удалось пересчитать риск: {message}',
  'portfolio.risk.aaveInputsHint':
    'Укажите адрес аккаунта Aave, чтобы прочитать его health factor и дистанцию до ликвидации.',
  ...
  'chartLegend.saveConfirm': 'Сохранить',

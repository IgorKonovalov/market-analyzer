...
ANALYZE_SYMBOL_DESCRIPTION = (
    ...
    "trailing support/resistance levels, any candlestick patterns on the most "
    "recent bars, and the active classical chart patterns (head & shoulders, "
    "doubles, triangles, wedges — forming or freshly confirmed) still in play. "
    "Returns {snapshot, partial_reason, message, analyzed_at}: "

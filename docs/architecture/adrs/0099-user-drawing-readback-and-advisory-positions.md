...
> **Status:** accepted (2026-07-15, at Plan 0104 close); **amended by [ADR-0101](0101-remove-agent-mode-gate.md)** (2026-07-14 — agent mode is removed, so decision 2's "the push event is agent-mode gated" clause falls: `ui.drawing_changed v1` forwards unconditionally; Plan 0104 phase 4 amended accordingly)
> **Date:** 2026-07-14
